...
#define PWMCR_ADDR          0x00E0
#define PWMDH_ADDR          0x00E1
#define PWMDL_ADDR          0x00E2
...
extern __sfr __at (PWMDH_ADDR)         PWMDH;    
extern __sfr __at (PWMDL_ADDR)         PWMDL;
...
#define PWMIE           INTCR2bits.PWMIE          /* bit 2 */
...
#define PWMIF           INTF2bits.PWMIF           /* bit 2 */
...
typedef union {
	struct {
		...
		unsigned char :1;
		unsigned char :1;
		unsigned char PWMPOC:1;
		unsigned char PWMNOC:1;
		unsigned char :1;
		unsigned char :1;
	};
} __PWMOCbits_t;
...
#define PWMPOC          PWMOCbits.PWMPOC          /* bit 4 */
#define PWMNOC          PWMOCbits.PWMNOC          /* bit 5 */
...
typedef union {
	struct {
		unsigned char TBS0 : 1;
		unsigned char TBS1 : 1;
		unsigned char DTEN:1;
		unsigned char FLTEN:1;
		unsigned char PWMNOE:1;
		unsigned char PWMPOE:1;
		unsigned char PWMMOD:1;
		unsigned char PWMEN:1;
	};
} __PWMCRbits_t;
extern volatile __PWMCRbits_t __at(PWMCR_ADDR) PWMCRbits;

#define TBS0            PWMCRbits.TBS0            /* bit 0 */
#define TBS1            PWMCRbits.TBS1            /* bit 1 */
#define DTEN            PWMCRbits.DTEN            /* bit 2 */
#define FLTEN           PWMCRbits.FLTEN           /* bit 3 */
#define PWMNOE          PWMCRbits.PWMNOE          /* bit 4 */
#define PWMPOE          PWMCRbits.PWMPOE          /* bit 5 */
#define PWMMOD          PWMCRbits.PWMMOD          /* bit 6 */
#define PWMEN           PWMCRbits.PWMEN           /* bit 7 */
...
extern volatile __PWMDHbits_t __at(PWMDH_ADDR) PWMDHbits;

#define PWMD4           PWMDHbits.PWMD4           /* bit 0 */
#define PWMD5           PWMDHbits.PWMD5           /* bit 1 */
#define PWMD6           PWMDHbits.PWMD6           /* bit 2 */
#define PWMD7           PWMDHbits.PWMD7           /* bit 3 */
#define PWMD8           PWMDHbits.PWMD8           /* bit 4 */
#define PWMD9           PWMDHbits.PWMD9           /* bit 5 */
#define PWMD10          PWMDHbits.PWMD10          /* bit 6 */
#define PWMD11          PWMDHbits.PWMD11          /* bit 7 */
...
extern volatile __PWMDLbits_t __at(PWMDL_ADDR) PWMDLbits;

#define PWMD0           PWMDLbits.PWMD0           /* bit 4 */
#define PWMD1           PWMDLbits.PWMD1           /* bit 5 */
#define PWMD2           PWMDLbits.PWMD2           /* bit 6 */
#define PWMD3           PWMDLbits.PWMD3           /* bit 7 */
...
typedef union {
	struct {
		...
		unsigned char :1;
		unsigned char :1;
		unsigned char PWMPOV:1;
		unsigned char PWMNOV:1;
		unsigned char :1;
		unsigned char :1;
	};
} __PWMOVbits_t;
...
#define PWMPOV          PWMOVbits.PWMPOV          /* bit 4 */
#define PWMNOV          PWMOVbits.PWMNOV          /* bit 5 */
...
#define SCOM0            LVDCRbits.SCOM0            /* bit 0 */
#define SCOM1            LVDCRbits.SCOM1            /* bit 1 */
#define SCOM2            LVDCRbits.SCOM2            /* bit 2 */
#define SCOM3            LVDCRbits.SCOM3            /* bit 3 */
#define RLCD0            LVDCRbits.RLCD0            /* bit 4 */
#define RLCD1            LVDCRbits.RLCD1            /* bit 5 */
#define RLCD2            LVDCRbits.RLCD2            /* bit 6 */
