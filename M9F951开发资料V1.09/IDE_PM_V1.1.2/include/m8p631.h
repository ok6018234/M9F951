...
#define CMPC0_ADDR          0x01A3
#define CMPC1_ADDR          0x01A4
#define OPAC0_ADDR          0x01A5
#define OPAC1_ADDR          0x01A6
#define COPAC_ADDR          0x01A7
#define RFCCR_ADDR          0x01A8
#define RFCCR0_ADDR         0x01A8
#define TKCTR_ADDR          0x01A9
#define ANSA_ADDR           0x01AA
#define ANSF_ADDR           0x01AB
...
#define LCDDS30_ADDR         0x019E
#define LCDDS31_ADDR         0x019F
//
//----- Register Files -----------------------------------------------------
//
...
extern __sfr __at (OPAC0_ADDR)         OPAC0;
extern __sfr __at (OPAC1_ADDR)         OPAC1;
extern __sfr __at (COPAC_ADDR)         COPAC;
...
extern __sfr __at (ANSF_ADDR)          ANSF;
...
#define CMPHIEN         CMPC1bits.CMPHIEN           /* bit 5 */
#define CMPOEN          CMPC1bits.CMPOEN            /* bit 7 */
...
typedef union {
	struct {
		...
		unsigned char OPAPS2:1;	
		unsigned char OPANS0:1;
		unsigned char OPANS1:1;	
		unsigned char OPANS2:1;	
		unsigned char OPAOUT:1;
		unsigned char OPAEN:1;
	};
} __OPAC0bits_t;
extern volatile __OPAC0bits_t __at(OPAC0_ADDR) OPAC0bits;

#define OPAPS0         OPAC0bits.OPAPS0          /* bit 0 */
#define OPAPS1         OPAC0bits.OPAPS1          /* bit 1 */
#define OPAPS2         OPAC0bits.OPAPS2          /* bit 2 */
#define OPANS0         OPAC0bits.OPANS0          /* bit 3 */
#define OPANS1         OPAC0bits.OPANS1          /* bit 4 */
#define OPANS2         OPAC0bits.OPANS2          /* bit 5 */
#define OPAOUT         OPAC0bits.OPAOUT          /* bit 6 */
#define OPAEN          OPAC0bits.OPAEN           /* bit 7 */
...
typedef union {
	struct {
		...
		unsigned char :1;
		unsigned char OPAOEN:1;	
	};
} __OPAC1bits_t;
extern volatile __OPAC1bits_t __at(OPAC1_ADDR) OPAC1bits;

#define OPAOF0          OPAC1bits.OPAOF0           /* bit 0 */
#define OPAOF1          OPAC1bits.OPAOF1           /* bit 1 */
#define OPAOF2          OPAC1bits.OPAOF2           /* bit 2 */
#define OPAOF3          OPAC1bits.OPAOF3           /* bit 3 */
#define OPAOFM          OPAC1bits.OPAOFM           /* bit 4 */
#define OPAHIEN         OPAC1bits.OPAHIEN          /* bit 5 */
#define OPAOEN          OPAC1bits.OPAOEN           /* bit 7 */
...
extern volatile __COPACbits_t __at(COPAC_ADDR) COPACbits;

#define A0SW0           COPACbits.A0SW0       	    /* bit 0 */
#define A0SW1           COPACbits.A0SW1       	    /* bit 1 */
#define A0SW2           COPACbits.A0SW2       	    /* bit 2 */
#define A0SW3           COPACbits.A0SW3       	    /* bit 3 */
#define OPAGS           COPACbits.OPAGS       	    /* bit 4 */
#define CINTS0          COPACbits.CINTS0            /* bit 6 */
#define CINTS1          COPACbits.CINTS1            /* bit 7 */
...
extern volatile __TKCTRbits_t __at(TKCTR_ADDR) TKCTRbits;

#define TKCHS0         TKCTRbits.TKCHS0          /* bit 0 */
#define TKCHS1         TKCTRbits.TKCHS1          /* bit 1 */
#define TKCHS2         TKCTRbits.TKCHS2          /* bit 2 */
#define TKCKS0         TKCTRbits.TKCKS0          /* bit 3 */
#define TKCKS1         TKCTRbits.TKCKS1          /* bit 4 */
#define TKCKS2         TKCTRbits.TKCKS2          /* bit 5 */
#define TKSTART        TKCTRbits.TKSTART         /* bit 6 */
#define TKEN           TKCTRbits.TKEN            /* bit 7 */
...
extern volatile __ANSFbits_t __at(ANSF_ADDR) ANSFbits;

#define ANSF6           ANSFbits.ANSF6            /* bit 6 */
#define ANSF7           ANSFbits.ANSF7      	    /* bit 7 */
...
#define ADOPT           ADCON2bits.ADOPT          /* bit 4 */
...
#define OPAIE           INTCR1bits.OPAIE     	    /* bit 6 */
...
#define OPAIF           INTF1bits.OPAIF           /* bit 6 */
