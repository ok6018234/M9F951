#ifndef __M8P8210_H__
#define __M8P8210_H__
...
#define PWM10D_ADDR         0x01DB
#define PWM11D_ADDR         0x01DC
#define PWM12D_ADDR         0x01DD
#define T2CR_ADDR           0x01DE
#define T2GCR_ADDR          0x01DF
#define PUA_ADDR            0x01E0
#define ANSCMP_ADDR         0x01E1
#define PUC_ADDR            0x01E2
#define PWM13D_ADDR         0x01E3
...
extern __sfr __at (PWM10D_ADDR)       PWM10D;
extern __sfr __at (PWM11D_ADDR)       PWM11D;
extern __sfr __at (PWM12D_ADDR)       PWM12D;
extern __sfr __at (T2CR_ADDR)         T2CR;
extern __sfr __at (T2GCR_ADDR)        T2GCR;
extern __sfr __at (PUA_ADDR)          PUA;
extern __sfr __at (ANSCMP_ADDR)       ANSCMP;
extern __sfr __at (PUC_ADDR)          PUC;
extern __sfr __at (PWM13D_ADDR)       PWM13D;
...
extern __sfr __at (ORCH_ADDR)         ORCH;
...
#define LCDFR2          LCDCR1bits.LCDFR2            /* bit 6 */
#define LCDFR3          LCDCR1bits.LCDFR3            /* bit 7 */
...
typedef union {
	struct {
		unsigned char VLCD0:1;
		unsigned char VLCD1:1;
		unsigned char VLCD2:1;	
		unsigned char VLCD3:1;	
		unsigned char VLCD4:1;
		unsigned char SPEED0:1;
		unsigned char SPEED1:1;
		unsigned char SPEED2:1;	
	};
} __LCDCR3bits_t;
extern volatile __LCDCR3bits_t __at(LCDCR3_ADDR) LCDCR3bits;

#define VLCD0          LCDCR3bits.VLCD0              /* bit 0 */
#define VLCD1          LCDCR3bits.VLCD1              /* bit 1 */
#define VLCD2          LCDCR3bits.VLCD2              /* bit 2 */
#define VLCD3          LCDCR3bits.VLCD3              /* bit 3 */
#define VLCD4          LCDCR3bits.VLCD4              /* bit 4 */
#define SPEED0         LCDCR3bits.SPEED0             /* bit 5 */
#define SPEED1         LCDCR3bits.SPEED1             /* bit 6 */
#define SPEED2         LCDCR3bits.SPEED2             /* bit 7 */
...
#define PWM0OE          PWM0CRbits.PWM0OE          /* bit 0 */
#define PWM0EN          PWM0CRbits.PWM0EN          /* bit 1 */
...
typedef union {
	struct {
		unsigned char PWM10OE:1;
		unsigned char PWM10EN:1;
		unsigned char PWM11OE:1;
		unsigned char PWM11EN:1;
		unsigned char PWM12OE:1;
		unsigned char PWM12EN:1;
		unsigned char PWM13OE:1;
		unsigned char PWM13EN:1;
	};
} __PWM1CRbits_t;
extern volatile __PWM1CRbits_t __at(PWM1CR_ADDR) PWM1CRbits;

#define PWM10OE          PWM1CRbits.PWM10OE          /* bit 0 */
#define PWM10EN          PWM1CRbits.PWM10EN          /* bit 1 */
#define PWM11OE          PWM1CRbits.PWM11OE          /* bit 2 */
#define PWM11EN          PWM1CRbits.PWM11EN          /* bit 3 */
#define PWM12OE          PWM1CRbits.PWM12OE          /* bit 4 */
#define PWM12EN          PWM1CRbits.PWM12EN          /* bit 5 */
#define PWM13OE          PWM1CRbits.PWM13OE          /* bit 6 */
#define PWM13EN          PWM1CRbits.PWM13EN          /* bit 7 */

// ----- PWM10D Bits -------------------------------------------------------
typedef union {
	struct {
		unsigned char PWM10D0:1;
		unsigned char PWM10D1:1;
		unsigned char PWM10D2:1;
		unsigned char PWM10D3:1;
		unsigned char PWM10D4:1;
		unsigned char PWM10D5:1;
		unsigned char PWM10D6:1;
		unsigned char PWM10D7:1;
	};
} __PWM10Dbits_t;
extern volatile __PWM10Dbits_t __at(PWM10D_ADDR) PWM10Dbits;

#define PWM10D0         PWM10Dbits.PWM10D0         /* bit 0 */
#define PWM10D1         PWM10Dbits.PWM10D1         /* bit 1 */
#define PWM10D2         PWM10Dbits.PWM10D2         /* bit 2 */
#define PWM10D3         PWM10Dbits.PWM10D3         /* bit 3 */
#define PWM10D4         PWM10Dbits.PWM10D4         /* bit 4 */
#define PWM10D5         PWM10Dbits.PWM10D5         /* bit 5 */
#define PWM10D6         PWM10Dbits.PWM10D6         /* bit 6 */
#define PWM10D7         PWM10Dbits.PWM10D7         /* bit 7 */

// ----- PWM11D Bits -------------------------------------------------------
typedef union {
	struct {
		unsigned char PWM11D0:1;
		unsigned char PWM11D1:1;
		unsigned char PWM11D2:1;
		unsigned char PWM11D3:1;
		unsigned char PWM11D4:1;
		unsigned char PWM11D5:1;
		unsigned char PWM11D6:1;
		unsigned char PWM11D7:1;
	};
} __PWM11Dbits_t;
extern volatile __PWM11Dbits_t __at(PWM11D_ADDR) PWM11Dbits;

#define PWM11D0         PWM11Dbits.PWM11D0         /* bit 0 */
#define PWM11D1         PWM11Dbits.PWM11D1         /* bit 1 */
#define PWM11D2         PWM11Dbits.PWM11D2         /* bit 2 */
#define PWM11D3         PWM11Dbits.PWM11D3         /* bit 3 */
#define PWM11D4         PWM11Dbits.PWM11D4         /* bit 4 */
#define PWM11D5         PWM11Dbits.PWM11D5         /* bit 5 */
#define PWM11D6         PWM11Dbits.PWM11D6         /* bit 6 */
#define PWM11D7         PWM11Dbits.PWM11D7         /* bit 7 */

// ----- PWM12D Bits -------------------------------------------------------
typedef union {
	struct {
		unsigned char PWM12D0:1;
		unsigned char PWM12D1:1;
		unsigned char PWM12D2:1;
		unsigned char PWM12D3:1;
		unsigned char PWM12D4:1;
		unsigned char PWM12D5:1;
		unsigned char PWM12D6:1;
		unsigned char PWM12D7:1;
	};
} __PWM12Dbits_t;
extern volatile __PWM12Dbits_t __at(PWM12D_ADDR) PWM12Dbits;

#define PWM12D0         PWM12Dbits.PWM12D0         /* bit 0 */
#define PWM12D1         PWM12Dbits.PWM12D1         /* bit 1 */
#define PWM12D2         PWM12Dbits.PWM12D2         /* bit 2 */
#define PWM12D3         PWM12Dbits.PWM12D3         /* bit 3 */
#define PWM12D4         PWM12Dbits.PWM12D4         /* bit 4 */
#define PWM12D5         PWM12Dbits.PWM12D5         /* bit 5 */
#define PWM12D6         PWM12Dbits.PWM12D6         /* bit 6 */
#define PWM12D7         PWM12Dbits.PWM12D7         /* bit 7 */

// ----- PWM13D Bits -------------------------------------------------------
typedef union {
	struct {
		unsigned char PWM13D0:1;
		unsigned char PWM13D1:1;
		unsigned char PWM13D2:1;
		unsigned char PWM13D3:1;
		unsigned char PWM13D4:1;
		unsigned char PWM13D5:1;
		unsigned char PWM13D6:1;
		unsigned char PWM13D7:1;
	};
} __PWM13Dbits_t;
extern volatile __PWM13Dbits_t __at(PWM13D_ADDR) PWM13Dbits;

#define PWM13D0         PWM13Dbits.PWM13D0         /* bit 0 */
#define PWM13D1         PWM13Dbits.PWM13D1         /* bit 1 */
#define PWM13D2         PWM13Dbits.PWM13D2         /* bit 2 */
#define PWM13D3         PWM13Dbits.PWM13D3         /* bit 3 */
#define PWM13D4         PWM13Dbits.PWM13D4         /* bit 4 */
#define PWM13D5         PWM13Dbits.PWM13D5         /* bit 5 */
#define PWM13D6         PWM13Dbits.PWM13D6         /* bit 6 */
#define PWM13D7         PWM13Dbits.PWM13D7         /* bit 7 */
...
typedef union {
	struct {
		unsigned char ANSN0:1;
		unsigned char ANSN1:1;
		unsigned char ANSP0:1;
		unsigned char ANSP1:1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
...
extern volatile __ANSCMPbits_t __at(ANSCMP_ADDR) ANSCMPbits;

#define ANSN0            ANSCMPbits.ANSN0              /* bit 0 */
#define ANSN1            ANSCMPbits.ANSN1              /* bit 1 */
#define ANSP0            ANSCMPbits.ANSP0              /* bit 2 */
#define ANSP1            ANSCMPbits.ANSP1              /* bit 3 */
...
#define IOBDS            IODSCR0bits.IOBDS              /* bit 5 */
...
#define CINTS1            CMPC0bits.CINTS1              /* bit 5 */
