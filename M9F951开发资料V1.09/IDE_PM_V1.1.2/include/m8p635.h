...
#define CMP1C0_ADDR         0x0196
#define CMP1C1_ADDR         0x0197
...
#define PHASEL_ADDR         0X019E
#define PHASEH_ADDR         0X019F

#define PWM1PHCR_ADDR       0x01A0
#define TC3C_ADDR           0x01A3
#define TC3PR_ADDR          0x01A4
#define T3CR_ADDR           0x01A5
#define T3CTR_ADDR          0x01A5
...
extern __sfr __at (CMP1C0_ADDR)        CMP1C0;
extern __sfr __at (CMP1C1_ADDR)        CMP1C1;
...
extern __sfr __at (PHASEL_ADDR)        PHASEL;
extern __sfr __at (PHASEH_ADDR)        PHASEH;

extern __sfr __at (PWM1PHCR_ADDR)      PWM1PHCR;
extern __sfr __at (TC3C_ADDR)          TC3C;
extern __sfr __at (TC3PR_ADDR)         TC3PR;
extern __sfr __at (T3CR_ADDR)          T3CR;
extern __sfr __at (T3CTR_ADDR)          T3CTR;
...
extern __sfr __at (I2CBUF_ADDR)        I2CUBF;
...
extern __sfr __at (IRCCAL_ADDR)        IRSSAL;
...
typedef union {
	struct {
		unsigned char CMP1PS0 : 1;
		unsigned char CMP1PS1 : 1;
		unsigned char CMP1PS2 : 1;
		unsigned char CMP1NS0 : 1;
		unsigned char CMP1NS1 : 1;
		unsigned char CMP1NS2 : 1;
		unsigned char CMP1OUT : 1;
		unsigned char CMP1EN : 1;
	};
} __CMP1C0bits_t;
extern volatile __CMP1C0bits_t __at(CMP1C0_ADDR) CMP1C0bits;

#define CMP1PS0               CMP1C0bits.CMP1PS0              /* bit 0 */
#define CMP1PS1               CMP1C0bits.CMP1PS1              /* bit 1 */
#define CMP1PS2               CMP1C0bits.CMP1PS2              /* bit 2 */
#define CMP1NS0               CMP1C0bits.CMP1NS0              /* bit 3 */
#define CMP1NS1               CMP1C0bits.CMP1NS1              /* bit 4 */
#define CMP1NS2               CMP1C0bits.CMP1NS2              /* bit 5 */
#define CMP1OUT               CMP1C0bits.CMP1OUT              /* bit 6 */
#define CMP1EN                CMP1C0bits.CMP1EN               /* bit 7 */
...
typedef union {
	struct {
		unsigned char CMP1OF0 : 1;
		unsigned char CMP1OF1 : 1;
		unsigned char CMP1OF2 : 1;
		unsigned char CMP1OF3 : 1;
		unsigned char CMP1OFM : 1;
		unsigned char CMP1HIEN : 1;
		unsigned char  : 1;
		unsigned char CMP1OEN : 1;
	};
} __CMP1C1bits_t;
extern volatile __CMP1C1bits_t __at(CMP1C1_ADDR) CMP1C1bits;

#define CMP1OF0               CMP1C1bits.CMP1OF0              /* bit 0 */
#define CMP1OF1               CMP1C1bits.CMP1OF1              /* bit 1 */
#define CMP1OF2               CMP1C1bits.CMP1OF2              /* bit 2 */
#define CMP1OF3               CMP1C1bits.CMP1OF3              /* bit 3 */
#define CMP1OFM               CMP1C1bits.CMP1OFM              /* bit 4 */
#define CMP1HIEN              CMP1C1bits.CMP1HIEN             /* bit 5 */
#define CMP1OEN               CMP1C1bits.CMP1OEN              /* bit 7 */
...
typedef union {
	struct {
		unsigned char PHASEL0 : 1;
		unsigned char PHASEL1 : 1;
		unsigned char PHASEL2 : 1;
		unsigned char PHASEL3 : 1;
		unsigned char PHASEL4 : 1;
		unsigned char PHASEL5 : 1;
		unsigned char PHASEL6 : 1;
		unsigned char PHASEL7 : 1;
	};
} __PHASELbits_t;
extern volatile __PHASELbits_t __at(PHASEL_ADDR) PHASELbits;

#define PHASEL0               PHASELbits.PHASEL0              /* bit 0 */
#define PHASEL1               PHASELbits.PHASEL1              /* bit 1 */
#define PHASEL2               PHASELbits.PHASEL2              /* bit 2 */
#define PHASEL3               PHASELbits.PHASEL3              /* bit 3 */
#define PHASEL4               PHASELbits.PHASEL4              /* bit 4 */
#define PHASEL5               PHASELbits.PHASEL5              /* bit 5 */
#define PHASEL6               PHASELbits.PHASEL6              /* bit 6 */
#define PHASEL7               PHASELbits.PHASEL7              /* bit 7 */
...
typedef union {
	struct {
		unsigned char PHASEH0 : 1;
		unsigned char PHASEH1 : 1;
		unsigned char PHASEH2 : 1;
		unsigned char PHASEH3 : 1;
		unsigned char PHASEH4 : 1;
		unsigned char PHASEH5 : 1;
		unsigned char PHASEH6 : 1;
		unsigned char PHASEH7 : 1;
	};
} __PHASEHbits_t;
extern volatile __PHASEHbits_t __at(PHASEH_ADDR) PHASEHbits;

#define PHASEH0               PHASEHbits.PHASEH0              /* bit 0 */
#define PHASEH1               PHASEHbits.PHASEH1              /* bit 1 */
#define PHASEH2               PHASEHbits.PHASEH2              /* bit 2 */
#define PHASEH3               PHASEHbits.PHASEH3              /* bit 3 */
#define PHASEH4               PHASEHbits.PHASEH4              /* bit 4 */
#define PHASEH5               PHASEHbits.PHASEH5              /* bit 5 */
#define PHASEH6               PHASEHbits.PHASEH6              /* bit 6 */
#define PHASEH7               PHASEHbits.PHASEH7              /* bit 7 */
...
extern volatile __PWM1PHCRbits_t __at(PWM1PHCR_ADDR) PWM1PHCRbits;

#define PHASEEN               PWM1PHCRbits.PHASEEN              /* bit 1 */
...
#define TC3EN               T3CRbits.TC3EN              /* bit 1 */
...
typedef union {
	struct {
		unsigned char   CMP0PS0 : 1;
		unsigned char   CMP0PS1 : 1;
		unsigned char   CMP0PS2 : 1;
		unsigned char   CMP0NS0 : 1;
		unsigned char   CMP0NS1 : 1;
		unsigned char   CMP0NS2: 1;
		unsigned char   CMP0OUT: 1;
		unsigned char   CMP0EN: 1;
	};
} __CMP0C0bits_t;
extern volatile __CMP0C0bits_t __at(CMP0C0_ADDR) CMP0C0bits;

#define CMP0PS0               CMP0C0bits.CMP0PS0              /* bit 0 */
#define CMP0PS1               CMP0C0bits.CMP0PS1              /* bit 1 */
#define CMP0PS2               CMP0C0bits.CMP0PS2              /* bit 2 */
#define CMP0NS0               CMP0C0bits.CMP0NS0              /* bit 3 */
#define CMP0NS1               CMP0C0bits.CMP0NS1              /* bit 4 */
#define CMP0NS2               CMP0C0bits.CMP0NS2              /* bit 5 */
#define CMP0OUT               CMP0C0bits.CMP0OUT              /* bit 6 */
#define CMP0EN                CMP0C0bits.CMP0EN               /* bit 7 */
...
typedef union {
	struct {
		unsigned char   CMP0OF0 : 1;
		unsigned char   CMP0OF1 : 1;
		unsigned char   CMP0OF2 : 1;
		unsigned char   CMP0OF3 : 1;
		unsigned char   CMP0OFM : 1;
		unsigned char   CMP0HIEN : 1;
		unsigned char    : 1;
		unsigned char   CMP0OEN : 1;
	};
} __CMP0C1bits_t;
extern volatile __CMP0C1bits_t __at(CMP0C1_ADDR) CMP0C1bits;

#define CMP0OF0               CMP0C1bits.CMP0OF0              /* bit 0 */
#define CMP0OF1               CMP0C1bits.CMP0OF1              /* bit 1 */
#define CMP0OF2               CMP0C1bits.CMP0OF2              /* bit 2 */
#define CMP0OF3               CMP0C1bits.CMP0OF3              /* bit 3 */
#define CMP0OFM               CMP0C1bits.CMP0OFM              /* bit 4 */
#define CMP0HIEN              CMP0C1bits.CMP0HIEN             /* bit 5 */
#define CMP0OEN               CMP0C1bits.CMP0OEN              /* bit 7 */
...
typedef union {
	struct {
		...
		unsigned char CM0PIF:1;
	};
} __INTF1bits_t;
extern volatile __INTF1bits_t __at(INTF1_ADDR) INTF1bits;

#define IOBHIF         INTF1bits.IOBHIF         /* bit 0 */
...
#define CM0PIF         INTF1bits.CM0PIF         /* bit 7 */
