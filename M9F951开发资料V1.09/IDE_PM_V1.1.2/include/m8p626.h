...
#define TKCHSL_ADDR         0x00B6
#define TKCHSH_ADDR         0x00B7
...
#define IOIDS_ADDR          0x00D4
#define I2CADR_ADDR         0x00D5
#define I2CCON_ADDR         0x00D6
#define I2CBUF_ADDR         0x00D7
#define PWM0CR_ADDR         0x00D8
#define PWM0D_ADDR          0x00D9
#define TXCR_ADDR           0x00DA
#define TXREG_ADDR          0x00DB
#define RXCR_ADDR           0x00DC
#define RXREG_ADDR          0x00DD
#define BRGDH_ADDR          0x00DE    
#define BRGDL_ADDR          0x00DF
...
#define EECON1_ADDR         0x00F0
#define EECON2_ADDR         0x00F1
...
extern __sfr __at (TKCHSL_ADDR)         TKCHSL;
extern __sfr __at (TKCHSH_ADDR)         TKCHSH;
...
typedef union {
	struct {
		unsigned char CAPS0:1;
		unsigned char CAPS1:1;
		unsigned char CAPS2:1;	
		unsigned char CAPS3:1;	
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;	
...
#define CAPS0           TKCTR1bits.CAPS0            /* bit 0 */
#define CAPS1           TKCTR1bits.CAPS1            /* bit 1 */
#define CAPS2           TKCTR1bits.CAPS2            /* bit 2 */
#define CAPS3           TKCTR1bits.CAPS3            /* bit 3 */
...
typedef union {
	struct {
		...
		unsigned char TKCHS4:1;
		unsigned char TKCHS5:1;
		unsigned char TKCHS6:1;
		unsigned char TKCHS7:1;	
	};
} __TKCHSLbits_t;
extern volatile __TKCHSLbits_t __at(TKCHSL_ADDR) TKCHSLbits;

#define TKCHS0         TKCHSLbits.TKCHS0            /* bit 0 */
#define TKCHS1         TKCHSLbits.TKCHS1            /* bit 1 */
#define TKCHS2         TKCHSLbits.TKCHS2            /* bit 2 */
#define TKCHS3         TKCHSLbits.TKCHS3            /* bit 3 */
#define TKCHS4         TKCHSLbits.TKCHS4            /* bit 4 */
#define TKCHS5         TKCHSLbits.TKCHS5            /* bit 5 */
#define TKCHS6         TKCHSLbits.TKCHS6            /* bit 6 */
#define TKCHS7         TKCHSLbits.TKCHS7            /* bit 7 */

// ----- TKCHSH Bits --------------------------------------------------------
typedef union {
	struct {
		unsigned char TKCHS8:1;
		unsigned char TKCHS9:1;
		unsigned char TKCHS10:1;	
		unsigned char :1;	
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
...
extern volatile __TKCHSHbits_t __at(TKCHSL_ADDR) TKCHSHbits;

#define TKCHS8          TKCHSHbits.TKCHS8             /* bit 0 */
#define TKCHS9          TKCHSHbits.TKCHS9             /* bit 1 */
#define TKCHS10         TKCHSHbits.TKCHS10            /* bit 2 */
...
#define PUC1            PUCbits.PUC1              /* bit 5 */
...
#define ANSC1            ANSCbits.ANSC1              /* bit 5 */
...
extern volatile __PWM1DEADbits_t __at(PWM1DEAD_ADDR) PWM1DEADbits;

#define DEADTR0         PWM1DEADbits.DEADTR0        /* bit 0 */
#define DEADTR1         PWM1DEADbits.DEADTR1        /* bit 1 */
#define DEADTR2         PWM1DEADbits.DEADTR2        /* bit 2 */
#define DEADTR3         PWM1DEADbits.DEADTR3        /* bit 3 */
#define DEADTF0         PWM1DEADbits.DEADTF0        /* bit 4 */
#define DEADTF1         PWM1DEADbits.DEADTF1        /* bit 5 */
#define DEADTF2         PWM1DEADbits.DEADTF2        /* bit 6 */
#define DEADTF3         PWM1DEADbits.DEADTF3        /* bit 7 */
