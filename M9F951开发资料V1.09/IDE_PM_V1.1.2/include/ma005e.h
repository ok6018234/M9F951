...
#define EE_Data_ADDR            0x01D4
#define EE_OE_ADDR            0x01D5
#define EE_PU_ADDR            0x01D6
...
extern __sfr __at (TK1CTR_ADDR)       TK1CTR;
...
extern __sfr __at (TK0CTR_ADDR)       TK0CTR;
...
extern __sfr __at (EE_Data_ADDR)           EE_Data;
extern __sfr __at (EE_OE_ADDR)           EE_OE;
extern __sfr __at (EE_PU_ADDR)           EE_PU;
...
typedef union {
	struct {
		unsigned char EE_SCL:1;
		unsigned char :1;
		unsigned char :1;
		unsigned char EE_SDA:1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
...
extern volatile __EE_Databits_t __at(EE_Data_ADDR) EE_Databits;

#define EE_SCL            EE_Databits.EE_SCL              /* bit 0 */
#define EE_SDA            EE_Databits.EE_SDA              /* bit 3 */

// ----- EE_OE Bits -------------------------------------------------------
typedef union {
	struct {
		unsigned char EE_SCL_OE:1;
		unsigned char :1;
		unsigned char :1;
		unsigned char EE_SDA_OE:1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
...
extern volatile __EE_OEbits_t __at(EE_OE_ADDR) EE_OEbits;

#define EE_SCL_OE            EE_OEbits.EE_SCL_OE              /* bit 0 */
#define EE_SDA_OE            EE_OEbits.EE_SDA_OE              /* bit 1 */

// ----- EE_PU Bits -------------------------------------------------------
typedef union {
	struct {
		unsigned char EE_SCL_PU:1;
		unsigned char :1;
		unsigned char :1;
		unsigned char EE_SDA_PU:1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
		unsigned char :1;
...
extern volatile __EE_PUbits_t __at(EE_PU_ADDR) EE_PUbits;

#define EE_SCL_PU            EE_PUbits.EE_SCL_PU              /* bit 0 */
#define EE_SDA_PU            EE_PUbits.EE_SDA_PU              /* bit 3 */
