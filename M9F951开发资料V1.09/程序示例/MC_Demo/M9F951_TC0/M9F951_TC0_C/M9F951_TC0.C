...
*说明：本范例以TCO为定时器，每定时1ms翻转一次IOB0口
******************************************************************************/
//=============================================================================
//*******************************头文件和调用申明******************************
//=============================================================================
...
void TC0_INIT(void);					//TC0初始化
void TC0_Interrupt (void);				//TC0中断处理函数


//-----------------------------------------------------------------------------
//定义变量
volatile ab8 R_Flag;			//定义位寄存器
#define		b_TC0_F		R_Flag.oneBit.b0		//TC0中断标志
