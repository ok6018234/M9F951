...
* Project Name       : M9F951_SPI_Slave.prj
* File Name          : M9F951_SPI_Slave.C
* Author             : MASSES CHIP
* Version            : V2.00
* Date               : 2021/09/15
...
*;说明：端口SS0(IOF7)、SCK0(IOF6)、SDO0(IOF5)、DI0(IOF4)，
*向主机发送数据0x13,0x23,0x33,0x43，接收主机发送的数据存在Receive_Data
******************************************************************************/
//=============================================================================
//*******************************头文件和调用申明******************************
//=============================================================================
...
//-----------------------------------------------------------------------------
//定义变量
volatile unsigned char Receive_Data;
//=============================================================================
//********************************程序主函数***********************************
//=============================================================================
...
void SPI_Interrupt(void)
{
	if(I2C0IF==1)
	{
		...
		I2C0DBUF = 0x23;
		I2C0DBUF = 0x33;
		I2C0DBUF = 0x43;			//从机发送数据
		while(S0IF==0);
		SPI_RBUF = I2C0DBUF;		//接收主机发送的数据N=4，读取4次BUF值
		SPI_RBUF = I2C0DBUF;
		SPI_RBUF = I2C0DBUF;
		SPI_RBUF = I2C0DBUF;		
	}
